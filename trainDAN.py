...
# datasetDir = "/data/"
trainSet = ImageServer.Load(datasetDir + "dataset_nimgs=75660_perturbations=[0.2, 0.2, 20, 0.25]_size=[112, 112].npz")
...
initLandmarks = trainSet.initLandmarks[0].reshape((1, 148))
    ...
    for epoch in range(20):
        ...
        while Count * 2 < Xtrain.shape[0]:
            ...
            if Count % 8 == 0:
                ...
                print('{"metric": "test error", "value": ' + str(TestErr) + '}')
                print('{"metric": "batch error", "value": ' + str(BatchErr) + '}')

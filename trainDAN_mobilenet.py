...
with tf.Session() as sess:
    ...
    if STAGE < 2:
        ...
        Saver.restore(sess,'./Model_mobilenet/Model')
    ...
    for epoch in range(2):
        Count = 0
        while Count * 2 < 2:#Xtrain.shape[0]:
            ...
            if Count % 8 == 0:
                ...
                if STAGE == 1 or STAGE == 0:
                    ...
                    # print(debug.shape)
                    # print(evaluateBatchError(Yvalid.reshape([-1, 74, 2]), S1_Ret.reshape([-1, 74, 2]), 9))
            ...
            Count += 1
        Saver.save(sess,'./Model_mobilenet/Model')
